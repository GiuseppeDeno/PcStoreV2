...
public class MyControllerPc {
	...
	public String getIndex(Model m1) {
		 ...
		 listaPc.add(new pc("Aspire 3 A315-24P","Acer"," Computer portatile Intel Core i7 12Th, 10 cORe, Ram 16Gb, SSD 512Gb +" ,499.00,"https://m.media-amazon.com/images/I/51325dqOYYL._AC_.jpg"));
	 ...
	 //nota bene .da spiegazione online 
	 //>>>>>>>>>>>>>>/Cosa fa @PostMapping

//@PostMapping indica che il metodo associato deve rispondere solo alle richieste HTTP POST.
//A differenza di @GetMapping (che è usato per richieste GET, come recuperare dati dal server), @PostMapping è tipicamente usato per:
//
//    Creare una nuova risorsa nel server (ad esempio, creare un nuovo utente in un database).
//    Inviare dati sensibili (come credenziali di accesso) in modo sicuro, dato che le richieste POST non includono i dati nell'URL.
	 @PostMapping("/process")
